...
@implementation TTGetAddressBook


#pragma mark - 获取iphone通讯录权限
...
+ (void)getOriginalAddressBook:(AddressBookArrayBlock)addressBookArray authorizationFailure:(AuthorizationFailure)failure
{
    ...
    dispatch_async(queue, ^{
        ...
        [TTAddressBookHandle getAddressBookDataSource:^(TTPersonModel *model) {
            //将单个联系人模型装进数组
...
#pragma mark - 获取按首字母A~Z顺序排列的所有联系人
