...
- (void)addDefaultPageWithImageName:(NSString*)imageName andTitle:(NSString*)title
{
    ...
    if (!self.defaultPageView)
    {
        ...
        [defaultBgView setFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 400)];
        ...
        [titleLabel setFrame:CGRectMake(15, 218, defaultBgView.frame.size.width-30, 14)];
